...
import { locale, updateLocale, showCart, shoppingCart } from "../../app.js";
...
let Navbar = {
    render: async () => {
        ...
        let navLinkDemo = i18n.getString("Navbar", "navLinkDemo");

        //screen-reader label for the cart icon: "2 items in cart"
        let cartItems = 0;
        for (let key in shoppingCart) { cartItems += shoppingCart[key].qty; }
        let cartStatus = i18n.t("Navbar", "cartStatus", { count: cartItems });
        ...
        let localeDE = i18n.getString("LocaleSelector", "localeDE");
        let localePseudo = i18n.getString("LocaleSelector", "localePseudo");
        ...
        <section id="headOptions">
            ...
            <img src="img/cart.svg" class="cartIcon" alt="${cartAlt}" title="${cartStatus}">
            <span class="visuallyHidden" role="status" aria-live="polite">${cartStatus}</span>
            <div class="localeSelector">
              ...
              <select id="locale" class="hamDrop">
                ...
                <option value="en-XA">${localePseudo}</option>
              </select>
            </div>
        </section>
    </header>
    <nav>
        ...
        <ul>
            ...
            <li><a href="./#/i18n" class="navLink" id="i18n">${navLinkDemo}</a></li>
        </ul>
    </nav>
    `;
        return view
